FROM    hongtat79/base-debian:latest
ARG     HTTP_PROXY
ARG     HTTPS_PROXY
...
ADD     https://github.com/hongtat/docker-debian-php/raw/master/instantclient/instantclient-basic-linux.x64-${INSTANTCLIENT_VERSION}.zip /tmp/
ADD     https://github.com/hongtat/docker-debian-php/raw/master/instantclient/instantclient-sdk-linux.x64-${INSTANTCLIENT_VERSION}.zip /tmp/
ADD     https://github.com/hongtat/docker-debian-php/raw/master/instantclient/instantclient-sqlplus-linux.x64-${INSTANTCLIENT_VERSION}.zip /tmp/
ADD     https://github.com/hongtat/docker-debian-php/raw/master/instantclient/sqlnet.ora /tmp/
